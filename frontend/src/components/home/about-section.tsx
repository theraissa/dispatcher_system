...
export default function AboutSection() {
  return (
    <section id="about-section" className="py-16 md:py-32 px-4 md:px-6 bg-[#D8C4B6] flex justify-center items-center">
      <div className={cn(
        "max-w-4xl w-full bg-white p-8 md:p-16",
        ...
        {/* Detalhe de Rodapé da Seção */}
        <div className="pt-4 border-t border-zinc-100 w-full">
          <p className="text-[10px] md:text-sm font-medium text-zinc-400 uppercase tracking-widest">
